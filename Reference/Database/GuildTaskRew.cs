...
namespace Database {
	public partial class GuildTaskRew {
		const string DBName = "guild_task_rew";
		#region members
		private int m_id = 0;
		private int m_Guildta_group = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, GuildTaskRew> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GuildTaskRew>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int Guildta_group { get { return m_Guildta_group; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static GuildTaskRew __default = null;
		static int __hash = 0;
		...
		static GuildTaskRew() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GuildTaskRew ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GuildTaskRew> idCacheData {
		...
		static GuildTaskRew ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GuildTaskRew();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_Guildta_group = __mask[ 0 ] ? q.GetInt( DBCache.FID_Guildta_group, 13 ) : __default.m_Guildta_group;
				GuildTaskRewEx.IsValid_Guildta_reward = __mask[ 1 ];
				if ( GuildTaskRewEx.onLoadComplexField_Guildta_reward != null ) {
					GuildTaskRewEx.onLoadComplexField_Guildta_reward( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static GuildTaskRew Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GuildTaskRew ret = null;
		...
		const int VersionHash = 0x0ffe3482;
		#endregion
	}

	public partial class GuildTaskRewEx {
		public delegate void LoadComplexField( GuildTaskRew data, LuaDatabase.Query q );
		internal static bool IsValid_Guildta_reward = true;
		static LoadComplexField OnLoadComplexField_Guildta_reward = null;
		public static LoadComplexField onLoadComplexField_Guildta_reward {
			get {
				return OnLoadComplexField_Guildta_reward;
			}
		}
	}
}
