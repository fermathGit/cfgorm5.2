...
namespace Database {
	public partial class SkillEffect {
		const string DBName = "skilleffect";
		#region members
		private int m_id = 0;
		private int m_EffectDelay = 0;
		private int m_EffectTarget = 0;
		private int m_EffectTargetType = 0;
		private int m_EffectType = 0;
		private float m_Param1 = 0;
		private float m_Param2 = 0;
		private int m_TargetNum = 0;
		private int m_TargetRange = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, SkillEffect> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, SkillEffect>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int EffectDelay { get { return m_EffectDelay; } }
		public int EffectTarget { get { return m_EffectTarget; } }
		public int EffectTargetType { get { return m_EffectTargetType; } }
		public int EffectType { get { return m_EffectType; } }
		public float Param1 { get { return m_Param1; } }
		public float Param2 { get { return m_Param2; } }
		public int TargetNum { get { return m_TargetNum; } }
		public int TargetRange { get { return m_TargetRange; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static SkillEffect __default = null;
		static int __hash = 0;
		...
		static SkillEffect() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( SkillEffect ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, SkillEffect> idCacheData {
		...
		static SkillEffect ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new SkillEffect();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_EffectDelay = __mask[ 0 ] ? q.GetInt( DBCache.FID_EffectDelay, 11 ) : __default.m_EffectDelay;
				temp.m_EffectTarget = __mask[ 1 ] ? q.GetInt( DBCache.FID_EffectTarget, 12 ) : __default.m_EffectTarget;
				temp.m_EffectTargetType = __mask[ 2 ] ? q.GetInt( DBCache.FID_EffectTargetType, 16 ) : __default.m_EffectTargetType;
				temp.m_EffectType = __mask[ 3 ] ? q.GetInt( DBCache.FID_EffectType, 10 ) : __default.m_EffectType;
				temp.m_Param1 = __mask[ 4 ] ? q.GetFloat( DBCache.FID_Param1, 6 ) : __default.m_Param1;
				temp.m_Param2 = __mask[ 5 ] ? q.GetFloat( DBCache.FID_Param2, 6 ) : __default.m_Param2;
				temp.m_TargetNum = __mask[ 6 ] ? q.GetInt( DBCache.FID_TargetNum, 9 ) : __default.m_TargetNum;
				temp.m_TargetRange = __mask[ 7 ] ? q.GetInt( DBCache.FID_TargetRange, 11 ) : __default.m_TargetRange;
				return temp;
			}
			return null;
		}

 		public static SkillEffect Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
		...
		const int VersionHash = 0x5321a234;
		#endregion
	}
}
//EOF
