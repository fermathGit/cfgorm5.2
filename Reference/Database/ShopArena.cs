...
namespace Database {
	public partial class ShopArena {
		const string DBName = "shop_arena";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, ShopArena> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ShopArena>();
		#endregion
		#region properties
		...
		static ShopArena __default = null;
		static int __hash = 0;
		...
		static ShopArena() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ShopArena ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ShopArena> idCacheData {
		...
		static ShopArena ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ShopArena();
 		...
 		public static ShopArena Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ShopArena ret = null;
