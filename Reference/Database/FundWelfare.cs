...
namespace Database {
	public partial class FundWelfare {
		const string DBName = "fund_welfare";
		#region members
		private int m_id = 0;
		private int m_fund_num = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, FundWelfare> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, FundWelfare>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int fund_num { get { return m_fund_num; } }
		...
		static FundWelfare __default = null;
		static int __hash = 0;
		...
		static FundWelfare() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( FundWelfare ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, FundWelfare> idCacheData {
		...
		static FundWelfare ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new FundWelfare();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_fund_num = __mask[ 0 ] ? q.GetInt( DBCache.FID_fund_num, 8 ) : __default.m_fund_num;
				temp.m_item = __mask[ 1 ] ? q.GetInt( DBCache.FID_item, 4 ) : __default.m_item;
				temp.m_needlevel = __mask[ 2 ] ? q.GetInt( DBCache.FID_needlevel, 9 ) : __default.m_needlevel;
 		...
 		public static FundWelfare Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			FundWelfare ret = null;
		...
		const int VersionHash = 0x3e0f13bd;
		#endregion
	}
}
//EOF
