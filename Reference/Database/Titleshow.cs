...
namespace Database {
	public partial class Titleshow {
		const string DBName = "titleshow";
		#region members
		private int m_id = 0;
		...
		private string m_VFX_Sound = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Titleshow> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Titleshow>();
		#endregion
		#region properties
		...
		public string VFX_Sound { get { return m_VFX_Sound; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Titleshow __default = null;
		static int __hash = 0;
		...
		static Titleshow() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Titleshow ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Titleshow> idCacheData {
		...
		static Titleshow ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Titleshow();
				...
				temp.m_show3_time = __mask[ 1 ] ? q.GetInt( DBCache.FID_show3_time, 10 ) : __default.m_show3_time;
				temp.m_Speech = __mask[ 2 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_Speech, 6 ) : __default.m_Speech;
				temp.m_Title = __mask[ 3 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_Title, 5 ) : __default.m_Title;
				temp.m_Title_Name = __mask[ 4 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_Title_Name, 10 ) : __default.m_Title_Name;
				temp.m_VFX_Sound = __mask[ 5 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_VFX_Sound, 9 ) : __default.m_VFX_Sound;
				return temp;
			}
			return null;
		}

 		public static Titleshow Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Titleshow ret = null;
		...
		const int VersionHash = 0x108a78fb;
		#endregion
	}
}
//EOF
