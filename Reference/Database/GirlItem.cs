...
namespace Database {
	public partial class GirlItem {
		const string DBName = "girlitem";
		#region members
		private int m_id = 0;
		private int m_Ornam_base = 0;
		private int m_Ornam_icon = 0;
		private string m_Ornam_mord = String.Empty;
		private string m_Ornam_name = String.Empty;
		private int m_Ornam_type = 0;
		private int m_sort = 0;
		private int m_time = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, GirlItem> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GirlItem>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int Ornam_base { get { return m_Ornam_base; } }
		public int Ornam_icon { get { return m_Ornam_icon; } }
		public string Ornam_mord { get { return m_Ornam_mord; } }
		public string Ornam_name { get { return m_Ornam_name; } }
		public int Ornam_type { get { return m_Ornam_type; } }
		public int sort { get { return m_sort; } }
		public int time { get { return m_time; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static GirlItem __default = null;
		static int __hash = 0;
		...
		static GirlItem() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GirlItem ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GirlItem> idCacheData {
		...
		static GirlItem ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GirlItem();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_Ornam_base = __mask[ 0 ] ? q.GetInt( DBCache.FID_Ornam_base, 10 ) : __default.m_Ornam_base;
				temp.m_Ornam_icon = __mask[ 1 ] ? q.GetInt( DBCache.FID_Ornam_icon, 10 ) : __default.m_Ornam_icon;
				temp.m_Ornam_mord = __mask[ 2 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_Ornam_mord, 10 ) : __default.m_Ornam_mord;
				temp.m_Ornam_name = __mask[ 3 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_Ornam_name, 10 ) : __default.m_Ornam_name;
				temp.m_Ornam_type = __mask[ 4 ] ? q.GetInt( DBCache.FID_Ornam_type, 10 ) : __default.m_Ornam_type;
 		...
 		public static GirlItem Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GirlItem ret = null;
		...
		const int VersionHash = 0x0fd95ee4;
		#endregion
	}
}
//EOF
