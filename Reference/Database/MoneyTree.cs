...
namespace Database {
	public partial class MoneyTree {
		const string DBName = "money_tree";
		#region members
		private int m_id = 0;
		private int m_moneyt_cost = 0;
		private int m_moneyt_money_1 = 0;
		private int m_moneyt_money_2 = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, MoneyTree> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, MoneyTree>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int moneyt_cost { get { return m_moneyt_cost; } }
		public int moneyt_money_1 { get { return m_moneyt_money_1; } }
		public int moneyt_money_2 { get { return m_moneyt_money_2; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static MoneyTree __default = null;
		static int __hash = 0;
		...
		static MoneyTree() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( MoneyTree ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, MoneyTree> idCacheData {
		...
		static MoneyTree ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new MoneyTree();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_moneyt_cost = __mask[ 0 ] ? q.GetInt( DBCache.FID_moneyt_cost, 11 ) : __default.m_moneyt_cost;
				temp.m_moneyt_money_1 = __mask[ 1 ] ? q.GetInt( DBCache.FID_moneyt_money_1, 14 ) : __default.m_moneyt_money_1;
				temp.m_moneyt_money_2 = __mask[ 2 ] ? q.GetInt( DBCache.FID_moneyt_money_2, 14 ) : __default.m_moneyt_money_2;
				return temp;
			}
			return null;
		}

 		public static MoneyTree Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			MoneyTree ret = null;
		...
		const int VersionHash = 0x0ccd69f2;
		#endregion
	}
}
//EOF
