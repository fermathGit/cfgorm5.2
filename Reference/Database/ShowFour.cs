...
namespace Database {
	public partial class ShowFour {
		const string DBName = "show4";
		#region members
		private int m_id = 0;
		private int m_param_1 = 0;
		private string m_remark = String.Empty;
		private int m_show_dalay = 0;
		private int m_show_rate = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, ShowFour> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ShowFour>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int param_1 { get { return m_param_1; } }
		public string remark { get { return m_remark; } }
		public int show_dalay { get { return m_show_dalay; } }
		public int show_rate { get { return m_show_rate; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static ShowFour __default = null;
		static int __hash = 0;
		...
		static ShowFour() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ShowFour ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ShowFour> idCacheData {
		...
		static ShowFour ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ShowFour();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_param_1 = __mask[ 0 ] ? q.GetInt( DBCache.FID_param_1, 7 ) : __default.m_param_1;
				temp.m_remark = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_remark, 6 ) : __default.m_remark;
				temp.m_show_dalay = __mask[ 2 ] ? q.GetInt( DBCache.FID_show_dalay, 10 ) : __default.m_show_dalay;
				temp.m_show_rate = __mask[ 3 ] ? q.GetInt( DBCache.FID_show_rate, 9 ) : __default.m_show_rate;
				temp.m_type = __mask[ 5 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				ShowFourEx.IsValid_talk_id = __mask[ 4 ];
				if ( ShowFourEx.onLoadComplexField_talk_id != null ) {
					ShowFourEx.onLoadComplexField_talk_id( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static ShowFour Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ShowFour ret = null;
		...
		const int VersionHash = 0x4f570ec9;
		#endregion
	}

	public partial class ShowFourEx {
		public delegate void LoadComplexField( ShowFour data, LuaDatabase.Query q );
		internal static bool IsValid_talk_id = true;
		static LoadComplexField OnLoadComplexField_talk_id = null;
		public static LoadComplexField onLoadComplexField_talk_id {
			get {
				return OnLoadComplexField_talk_id;
			}
		}
	}
}
