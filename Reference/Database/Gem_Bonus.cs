...
namespace Database {
	public partial class Gem_Bonus {
		const string DBName = "gem_bonus";
		#region members
		private int m_id = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Gem_Bonus> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Gem_Bonus>();
		#endregion
		#region properties
		...
		static Gem_Bonus __default = null;
		static int __hash = 0;
		...
		static Gem_Bonus() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Gem_Bonus ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Gem_Bonus> idCacheData {
		...
		static Gem_Bonus ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Gem_Bonus();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				Gem_BonusEx.IsValid_bonus_prop = __mask[ 0 ];
				if ( Gem_BonusEx.onLoadComplexField_bonus_prop != null ) {
					Gem_BonusEx.onLoadComplexField_bonus_prop( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Gem_Bonus Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Gem_Bonus ret = null;
		...
		const int VersionHash = 0x3529c371;
		#endregion
	}

	public partial class Gem_BonusEx {
		public delegate void LoadComplexField( Gem_Bonus data, LuaDatabase.Query q );
		internal static bool IsValid_bonus_prop = true;
		static LoadComplexField OnLoadComplexField_bonus_prop = null;
		public static LoadComplexField onLoadComplexField_bonus_prop {
			get {
				return OnLoadComplexField_bonus_prop;
			}
		}
	}
}
