...
namespace Database {
	public partial class SignReward {
		const string DBName = "sign_reward";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, SignReward> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, SignReward>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int item { get { return m_item; } }
		public int num { get { return m_num; } }
		public int vip { get { return m_vip; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static SignReward __default = null;
		static int __hash = 0;
		...
		static SignReward() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( SignReward ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, SignReward> idCacheData {
		...
		static SignReward ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new SignReward();
				...
				temp.m_vip = __mask[ 2 ] ? q.GetInt( DBCache.FID_vip, 3 ) : __default.m_vip;
				return temp;
			}
			return null;
		}

 		public static SignReward Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			SignReward ret = null;
		...
		const int VersionHash = 0x0a239c1d;
		#endregion
	}
}
//EOF
