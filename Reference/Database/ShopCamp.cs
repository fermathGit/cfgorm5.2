...
namespace Database {
	public partial class ShopCamp {
		const string DBName = "shop_camp";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, ShopCamp> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ShopCamp>();
		#endregion
		#region properties
		...
		static ShopCamp __default = null;
		static int __hash = 0;
		...
		static ShopCamp() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ShopCamp ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ShopCamp> idCacheData {
		...
		static ShopCamp ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ShopCamp();
 		...
 		public static ShopCamp Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ShopCamp ret = null;
