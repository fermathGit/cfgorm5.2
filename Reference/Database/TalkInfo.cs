...
namespace Database {
	public partial class TalkInfo {
		const string DBName = "talkinfo";
		#region members
		private int m_id = 0;
		private string m_chat = String.Empty;
		private int m_show_time = 0;
		private string m_talk = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, TalkInfo> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, TalkInfo>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string chat { get { return m_chat; } }
		public int show_time { get { return m_show_time; } }
		public string talk { get { return m_talk; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static TalkInfo __default = null;
		static int __hash = 0;
		...
		static TalkInfo() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( TalkInfo ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, TalkInfo> idCacheData {
		...
		static TalkInfo ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new TalkInfo();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_chat = __mask[ 0 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_chat, 4 ) : __default.m_chat;
				temp.m_show_time = __mask[ 1 ] ? q.GetInt( DBCache.FID_show_time, 9 ) : __default.m_show_time;
				temp.m_talk = __mask[ 2 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_talk, 4 ) : __default.m_talk;
				return temp;
			}
			return null;
		}

 		public static TalkInfo Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			TalkInfo ret = null;
		...
		const int VersionHash = 0x080aeb1b;
		#endregion
	}
}
//EOF
