...
namespace Database {
	public partial class Battlefield_Single {
		const string DBName = "battlefield_single";
		#region members
		private int m_id = 0;
		private int m_career = 0;
		private int m_equip1 = 0;
		private int m_equip2 = 0;
		private int m_fighting = 0;
		private int m_intenslevel = 0;
		private int m_psex = 0;
		private int m_soul = 0;
		private int m_wing = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Battlefield_Single> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Battlefield_Single>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int career { get { return m_career; } }
		public int equip1 { get { return m_equip1; } }
		public int equip2 { get { return m_equip2; } }
		public int fighting { get { return m_fighting; } }
		public int intenslevel { get { return m_intenslevel; } }
		public int psex { get { return m_psex; } }
		public int soul { get { return m_soul; } }
		public int wing { get { return m_wing; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Battlefield_Single __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Battlefield_Single() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Battlefield_Single ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Battlefield_Single> idCacheData {
		...
		static Battlefield_Single ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Battlefield_Single();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_career = __mask[ 0 ] ? q.GetInt( DBCache.FID_career, 6 ) : __default.m_career;
				temp.m_equip1 = __mask[ 1 ] ? q.GetInt( DBCache.FID_equip1, 6 ) : __default.m_equip1;
				temp.m_equip2 = __mask[ 2 ] ? q.GetInt( DBCache.FID_equip2, 6 ) : __default.m_equip2;
				temp.m_fighting = __mask[ 3 ] ? q.GetInt( DBCache.FID_fighting, 8 ) : __default.m_fighting;
				temp.m_intenslevel = __mask[ 4 ] ? q.GetInt( DBCache.FID_intenslevel, 11 ) : __default.m_intenslevel;
				temp.m_psex = __mask[ 5 ] ? q.GetInt( DBCache.FID_psex, 4 ) : __default.m_psex;
				temp.m_soul = __mask[ 6 ] ? q.GetInt( DBCache.FID_soul, 4 ) : __default.m_soul;
				temp.m_wing = __mask[ 7 ] ? q.GetInt( DBCache.FID_wing, 4 ) : __default.m_wing;
				return temp;
			}
			return null;
		}

 		public static Battlefield_Single Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Battlefield_Single ret = null;
		...
		const int VersionHash = 0x4fe84509;
		#endregion
	}
}
//EOF
