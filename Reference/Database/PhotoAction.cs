...
namespace Database {
	public partial class PhotoAction {
		const string DBName = "photo_action";
		#region members
		private int m_id = 0;
		private string m_action_anni = String.Empty;
		private string m_action_name = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, PhotoAction> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, PhotoAction>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string action_anni { get { return m_action_anni; } }
		public string action_name { get { return m_action_name; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static PhotoAction __default = null;
		static int __hash = 0;
		...
		static PhotoAction() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( PhotoAction ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, PhotoAction> idCacheData {
		...
		static PhotoAction ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new PhotoAction();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_action_anni = __mask[ 0 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_action_anni, 11 ) : __default.m_action_anni;
				temp.m_action_name = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_action_name, 11 ) : __default.m_action_name;
				return temp;
			}
			return null;
		}

 		public static PhotoAction Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			PhotoAction ret = null;
		...
		const int VersionHash = 0x4eda09f1;
		#endregion
	}
}
//EOF
