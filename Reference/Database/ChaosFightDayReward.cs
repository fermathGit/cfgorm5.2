...
namespace Database {
	public partial class ChaosFightDayReward {
		const string DBName = "Chaosbattle_Dayreward";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, ChaosFightDayReward> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ChaosFightDayReward>();
		#endregion
		#region properties
		...
		static ChaosFightDayReward __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static ChaosFightDayReward() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ChaosFightDayReward ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ChaosFightDayReward> idCacheData {
		...
		static ChaosFightDayReward ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ChaosFightDayReward();
 		...
 		public static ChaosFightDayReward Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ChaosFightDayReward ret = null;
