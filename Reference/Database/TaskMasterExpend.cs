...
namespace Database {
	public partial class TaskMasterExpend {
		const string DBName = "task_masterexpend";
		#region members
		private int m_id = 0;
		private int m_altercost = 0;
		private int m_completecost = 0;
		private int m_moneytype = 0;
		private int m_moneytype1 = 0;
		private int m_moneytype2 = 0;
		private int m_orangecost = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, TaskMasterExpend> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, TaskMasterExpend>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int altercost { get { return m_altercost; } }
		public int completecost { get { return m_completecost; } }
		public int moneytype { get { return m_moneytype; } }
		public int moneytype1 { get { return m_moneytype1; } }
		public int moneytype2 { get { return m_moneytype2; } }
		public int orangecost { get { return m_orangecost; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static TaskMasterExpend __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static TaskMasterExpend() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( TaskMasterExpend ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, TaskMasterExpend> idCacheData {
		...
		static TaskMasterExpend ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new TaskMasterExpend();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_altercost = __mask[ 0 ] ? q.GetInt( DBCache.FID_altercost, 9 ) : __default.m_altercost;
				temp.m_completecost = __mask[ 1 ] ? q.GetInt( DBCache.FID_completecost, 12 ) : __default.m_completecost;
				temp.m_moneytype = __mask[ 2 ] ? q.GetInt( DBCache.FID_moneytype, 9 ) : __default.m_moneytype;
				temp.m_moneytype1 = __mask[ 3 ] ? q.GetInt( DBCache.FID_moneytype1, 10 ) : __default.m_moneytype1;
				temp.m_moneytype2 = __mask[ 4 ] ? q.GetInt( DBCache.FID_moneytype2, 10 ) : __default.m_moneytype2;
				temp.m_orangecost = __mask[ 5 ] ? q.GetInt( DBCache.FID_orangecost, 10 ) : __default.m_orangecost;
				return temp;
			}
			return null;
		}

 		public static TaskMasterExpend Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			TaskMasterExpend ret = null;
		...
		const int VersionHash = 0x151d1f4e;
		#endregion
	}
}
//EOF
