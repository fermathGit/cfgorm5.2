...
namespace Database {
	public partial class Pet_Group {
		const string DBName = "pet_group";
		#region members
		private int m_id = 0;
		private int m_passiveSkilles = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Pet_Group> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Pet_Group>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int passiveSkilles { get { return m_passiveSkilles; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Pet_Group __default = null;
		static int __hash = 0;
		...
		static Pet_Group() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Pet_Group ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Pet_Group> idCacheData {
		...
		static Pet_Group ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Pet_Group();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_passiveSkilles = __mask[ 0 ] ? q.GetInt( DBCache.FID_passiveSkilles, 14 ) : __default.m_passiveSkilles;
				return temp;
			}
			return null;
		}

 		public static Pet_Group Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Pet_Group ret = null;
		...
		const int VersionHash = 0x30775e31;
		#endregion
	}
}
//EOF
