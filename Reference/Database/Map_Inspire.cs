...
namespace Database {
	public partial class Map_Inspire {
		const string DBName = "map_Inspire";
		#region members
		private int m_id = 0;
		private int m_conunt = 0;
		private int m_costMoney = 0;
		private int m_costMoneyType = 0;
		private int m_expAddPer = 0;
		private int m_harmAddPer = 0;
		private string m_inspireSucess = String.Empty;
		private string m_inspireTips = String.Empty;
		private int m_mapId = 0;
		private int m_moneyAddPer = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Map_Inspire> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Map_Inspire>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int conunt { get { return m_conunt; } }
		public int costMoney { get { return m_costMoney; } }
		public int costMoneyType { get { return m_costMoneyType; } }
		public int expAddPer { get { return m_expAddPer; } }
		public int harmAddPer { get { return m_harmAddPer; } }
		public string inspireSucess { get { return m_inspireSucess; } }
		public string inspireTips { get { return m_inspireTips; } }
		public int mapId { get { return m_mapId; } }
		public int moneyAddPer { get { return m_moneyAddPer; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Map_Inspire __default = null;
		static int __hash = 0;
		...
		static Map_Inspire() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Map_Inspire ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Map_Inspire> idCacheData {
		...
		static Map_Inspire ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Map_Inspire();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_conunt = __mask[ 0 ] ? q.GetInt( DBCache.FID_conunt, 6 ) : __default.m_conunt;
				temp.m_costMoney = __mask[ 1 ] ? q.GetInt( DBCache.FID_costMoney, 9 ) : __default.m_costMoney;
				temp.m_costMoneyType = __mask[ 2 ] ? q.GetInt( DBCache.FID_costMoneyType, 13 ) : __default.m_costMoneyType;
				temp.m_expAddPer = __mask[ 3 ] ? q.GetInt( DBCache.FID_expAddPer, 9 ) : __default.m_expAddPer;
				temp.m_harmAddPer = __mask[ 4 ] ? q.GetInt( DBCache.FID_harmAddPer, 10 ) : __default.m_harmAddPer;
				temp.m_inspireSucess = __mask[ 5 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_inspireSucess, 13 ) : __default.m_inspireSucess;
				temp.m_inspireTips = __mask[ 6 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_inspireTips, 11 ) : __default.m_inspireTips;
				temp.m_mapId = __mask[ 7 ] ? q.GetInt( DBCache.FID_mapId, 5 ) : __default.m_mapId;
				temp.m_moneyAddPer = __mask[ 8 ] ? q.GetInt( DBCache.FID_moneyAddPer, 11 ) : __default.m_moneyAddPer;
				return temp;
			}
			return null;
		}

 		public static Map_Inspire Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Map_Inspire ret = null;
		...
		const int VersionHash = 0x76734344;
		#endregion
	}
}
//EOF
