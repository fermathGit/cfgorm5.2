...
namespace Database {
	public partial class ProtectEffect {
		const string DBName = "protect_effect";
		#region members
		private int m_id = 0;
		private int m_cd = 0;
		...
		private int m_publiccd = 0;
		private string m_skilldes = String.Empty;
		private string m_slot = String.Empty;
		private string m_vfx = String.Empty;
		private int m_warntips = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, ProtectEffect> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ProtectEffect>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int cd { get { return m_cd; } }
		public string des { get { return m_des; } }
		public int icon { get { return m_icon; } }
		public string name { get { return m_name; } }
		public string notice { get { return m_notice; } }
		public int publiccd { get { return m_publiccd; } }
		public string skilldes { get { return m_skilldes; } }
		public string slot { get { return m_slot; } }
		public string vfx { get { return m_vfx; } }
		public int warntips { get { return m_warntips; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static ProtectEffect __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static ProtectEffect() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ProtectEffect ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ProtectEffect> idCacheData {
		...
		static ProtectEffect ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ProtectEffect();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_cd = __mask[ 0 ] ? q.GetInt( DBCache.FID_cd, 2 ) : __default.m_cd;
				temp.m_des = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_des, 3 ) : __default.m_des;
				temp.m_icon = __mask[ 2 ] ? q.GetInt( DBCache.FID_icon, 4 ) : __default.m_icon;
				temp.m_name = __mask[ 3 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_name, 4 ) : __default.m_name;
				temp.m_notice = __mask[ 4 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_notice, 6 ) : __default.m_notice;
				temp.m_publiccd = __mask[ 5 ] ? q.GetInt( DBCache.FID_publiccd, 8 ) : __default.m_publiccd;
				temp.m_skilldes = __mask[ 6 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_skilldes, 8 ) : __default.m_skilldes;
				temp.m_slot = __mask[ 7 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_slot, 4 ) : __default.m_slot;
				temp.m_vfx = __mask[ 8 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_vfx, 3 ) : __default.m_vfx;
				temp.m_warntips = __mask[ 9 ] ? q.GetInt( DBCache.FID_warntips, 8 ) : __default.m_warntips;
				return temp;
			}
			return null;
		}

 		public static ProtectEffect Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ProtectEffect ret = null;
		...
		const int VersionHash = 0x17f2728c;
		#endregion
	}
}
//EOF
