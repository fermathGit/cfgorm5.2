...
namespace Database {
	public partial class TeamDirection {
		const string DBName = "team_direction";
		#region members
		private int m_id = 0;
		...
		private int m_showname = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, TeamDirection> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, TeamDirection>();
		#endregion
		#region properties
		...
		public int showname { get { return m_showname; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static TeamDirection __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static TeamDirection() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( TeamDirection ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, TeamDirection> idCacheData {
		...
		static TeamDirection ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new TeamDirection();
				...
				temp.m_difficulty = __mask[ 1 ] ? q.GetInt( DBCache.FID_difficulty, 10 ) : __default.m_difficulty;
				temp.m_direction = __mask[ 2 ] ? q.GetInt( DBCache.FID_direction, 9 ) : __default.m_direction;
				temp.m_mapdataId = __mask[ 3 ] ? q.GetInt( DBCache.FID_mapdataId, 9 ) : __default.m_mapdataId;
				temp.m_showname = __mask[ 4 ] ? q.GetInt( DBCache.FID_showname, 8 ) : __default.m_showname;
 		...
 		public static TeamDirection Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			TeamDirection ret = null;
		...
		const int VersionHash = 0x1eab7fe9;
		#endregion
	}
}
//EOF
