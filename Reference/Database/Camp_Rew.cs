...
namespace Database {
	public partial class Camp_Rew {
		const string DBName = "camp_rew";
		#region members
		private int m_id = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Camp_Rew> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Camp_Rew>();
		#endregion
		#region properties
		...
		static Camp_Rew __default = null;
		static int __hash = 0;
		...
		static Camp_Rew() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Camp_Rew ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Camp_Rew> idCacheData {
		...
		static Camp_Rew ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Camp_Rew();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				Camp_RewEx.IsValid_rew_item = __mask[ 0 ];
				if ( Camp_RewEx.onLoadComplexField_rew_item != null ) {
					Camp_RewEx.onLoadComplexField_rew_item( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Camp_Rew Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Camp_Rew ret = null;
		...
		const int VersionHash = 0x65b87e8a;
		#endregion
	}

	public partial class Camp_RewEx {
		public delegate void LoadComplexField( Camp_Rew data, LuaDatabase.Query q );
		internal static bool IsValid_rew_item = true;
		static LoadComplexField OnLoadComplexField_rew_item = null;
		public static LoadComplexField onLoadComplexField_rew_item {
			get {
				return OnLoadComplexField_rew_item;
			}
		}
	}
}
