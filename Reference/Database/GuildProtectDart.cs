...
namespace Database {
	public partial class GuildProtectDart {
		const string DBName = "guild_protect_dart";
		#region members
		private int m_id = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, GuildProtectDart> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GuildProtectDart>();
		#endregion
		#region properties
		...
		static GuildProtectDart __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static GuildProtectDart() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GuildProtectDart ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GuildProtectDart> idCacheData {
		...
		static GuildProtectDart ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GuildProtectDart();
				temp.m_id = id;
				return temp;
			}
			return null;
 		...
 		public static GuildProtectDart Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GuildProtectDart ret = null;
		...
		const int VersionHash = 0x00000000;
		#endregion
	}
}
//EOF
