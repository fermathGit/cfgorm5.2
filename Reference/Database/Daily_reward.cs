...
namespace Database {
	public partial class Daily_reward {
		const string DBName = "daily_reward";
		#region members
		private int m_id = 0;
		private int m_active_point = 0;
		private int m_active_reward = 0;
		private int m_active_reward_bind = 0;
		private int m_active_reward_num = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Daily_reward> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Daily_reward>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int active_point { get { return m_active_point; } }
		public int active_reward { get { return m_active_reward; } }
		public int active_reward_bind { get { return m_active_reward_bind; } }
		public int active_reward_num { get { return m_active_reward_num; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Daily_reward __default = null;
		static int __hash = 0;
		...
		static Daily_reward() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Daily_reward ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Daily_reward> idCacheData {
		...
		static Daily_reward ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Daily_reward();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_active_point = __mask[ 0 ] ? q.GetInt( DBCache.FID_active_point, 12 ) : __default.m_active_point;
				temp.m_active_reward = __mask[ 1 ] ? q.GetInt( DBCache.FID_active_reward, 13 ) : __default.m_active_reward;
				temp.m_active_reward_bind = __mask[ 2 ] ? q.GetInt( DBCache.FID_active_reward_bind, 18 ) : __default.m_active_reward_bind;
				temp.m_active_reward_num = __mask[ 3 ] ? q.GetInt( DBCache.FID_active_reward_num, 17 ) : __default.m_active_reward_num;
				temp.m_type = __mask[ 5 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				Daily_rewardEx.IsValid_show_reward = __mask[ 4 ];
				if ( Daily_rewardEx.onLoadComplexField_show_reward != null ) {
					Daily_rewardEx.onLoadComplexField_show_reward( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Daily_reward Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Daily_reward ret = null;
		...
		const int VersionHash = 0x2557444d;
		#endregion
	}

	public partial class Daily_rewardEx {
		public delegate void LoadComplexField( Daily_reward data, LuaDatabase.Query q );
		internal static bool IsValid_show_reward = true;
		static LoadComplexField OnLoadComplexField_show_reward = null;
		public static LoadComplexField onLoadComplexField_show_reward {
			get {
				return OnLoadComplexField_show_reward;
			}
		}
	}
}
