...
namespace Database {
	public partial class Offstringlogin {
		const string DBName = "offstringlogin";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, Offstringlogin> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Offstringlogin>();
		#endregion
		#region properties
		...
		static Offstringlogin __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Offstringlogin() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Offstringlogin ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Offstringlogin> idCacheData {
		...
		static Offstringlogin ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Offstringlogin();
 		...
 		public static Offstringlogin Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Offstringlogin ret = null;
