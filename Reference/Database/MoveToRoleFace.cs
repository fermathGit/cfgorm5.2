...
namespace Database {
	public partial class MoveToRoleFace {
		const string DBName = "roleface";
		#region members
		private int m_id = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, MoveToRoleFace> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, MoveToRoleFace>();
		#endregion
		#region properties
		...
		static MoveToRoleFace __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static MoveToRoleFace() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( MoveToRoleFace ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, MoveToRoleFace> idCacheData {
		...
		static MoveToRoleFace ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new MoveToRoleFace();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				MoveToRoleFaceEx.IsValid_site = __mask[ 0 ];
				if ( MoveToRoleFaceEx.onLoadComplexField_site != null ) {
					MoveToRoleFaceEx.onLoadComplexField_site( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static MoveToRoleFace Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			MoveToRoleFace ret = null;
		...
		const int VersionHash = 0x5a8daba1;
		#endregion
	}

	public partial class MoveToRoleFaceEx {
		public delegate void LoadComplexField( MoveToRoleFace data, LuaDatabase.Query q );
		internal static bool IsValid_site = true;
		static LoadComplexField OnLoadComplexField_site = null;
		public static LoadComplexField onLoadComplexField_site {
			get {
				return OnLoadComplexField_site;
			}
		}
	}
}
