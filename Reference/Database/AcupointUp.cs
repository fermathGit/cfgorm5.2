...
namespace Database {
	public partial class AcuPointUp {
		const string DBName = "acupointUp";
		#region members
		private int m_id = 0;
		private int m_acupointId = 0;
		private int m_icon = 0;
		private int m_level = 0;
		private int m_proType = 0;
		private int m_proValue = 0;
		private int m_type = 0;
		private int m_upNeedExp = 0;
		private int m_upNeedMoneyNum = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, AcuPointUp> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, AcuPointUp>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int acupointId { get { return m_acupointId; } }
		public int icon { get { return m_icon; } }
		public int level { get { return m_level; } }
		public int proType { get { return m_proType; } }
		public int proValue { get { return m_proValue; } }
		public int type { get { return m_type; } }
		public int upNeedExp { get { return m_upNeedExp; } }
		public int upNeedMoneyNum { get { return m_upNeedMoneyNum; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static AcuPointUp __default = null;
		static int __hash = 0;
		...
		static AcuPointUp() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( AcuPointUp ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, AcuPointUp> idCacheData {
		...
		static AcuPointUp ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new AcuPointUp();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_acupointId = __mask[ 0 ] ? q.GetInt( DBCache.FID_acupointId, 10 ) : __default.m_acupointId;
				temp.m_icon = __mask[ 1 ] ? q.GetInt( DBCache.FID_icon, 4 ) : __default.m_icon;
				temp.m_level = __mask[ 2 ] ? q.GetInt( DBCache.FID_level, 5 ) : __default.m_level;
				temp.m_proType = __mask[ 3 ] ? q.GetInt( DBCache.FID_proType, 7 ) : __default.m_proType;
				temp.m_proValue = __mask[ 4 ] ? q.GetInt( DBCache.FID_proValue, 8 ) : __default.m_proValue;
				temp.m_type = __mask[ 5 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				temp.m_upNeedExp = __mask[ 6 ] ? q.GetInt( DBCache.FID_upNeedExp, 9 ) : __default.m_upNeedExp;
				temp.m_upNeedMoneyNum = __mask[ 7 ] ? q.GetInt( DBCache.FID_upNeedMoneyNum, 14 ) : __default.m_upNeedMoneyNum;
				return temp;
			}
			return null;
		}

 		public static AcuPointUp Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			AcuPointUp ret = null;
		...
		const int VersionHash = 0x2e4d0111;
		#endregion
	}
}
//EOF
