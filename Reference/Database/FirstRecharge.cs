...
namespace Database {
	public partial class FirstRecharge {
		const string DBName = "first_recharge";
		#region members
		private int m_id = 0;
		private int m_gold_id = 0;
		private int m_ios_special = 0;
		private int m_reward_num = 0;
		private int m_reward_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, FirstRecharge> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, FirstRecharge>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int gold_id { get { return m_gold_id; } }
		public int ios_special { get { return m_ios_special; } }
		public int reward_num { get { return m_reward_num; } }
		public int reward_type { get { return m_reward_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static FirstRecharge __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static FirstRecharge() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( FirstRecharge ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, FirstRecharge> idCacheData {
		...
		static FirstRecharge ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new FirstRecharge();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_gold_id = __mask[ 0 ] ? q.GetInt( DBCache.FID_gold_id, 7 ) : __default.m_gold_id;
				temp.m_ios_special = __mask[ 1 ] ? q.GetInt( DBCache.FID_ios_special, 11 ) : __default.m_ios_special;
				temp.m_reward_num = __mask[ 2 ] ? q.GetInt( DBCache.FID_reward_num, 10 ) : __default.m_reward_num;
				temp.m_reward_type = __mask[ 3 ] ? q.GetInt( DBCache.FID_reward_type, 11 ) : __default.m_reward_type;
				return temp;
			}
			return null;
		}

 		public static FirstRecharge Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			FirstRecharge ret = null;
		...
		const int VersionHash = 0x5d353e99;
		#endregion
	}
}
//EOF
