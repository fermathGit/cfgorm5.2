...
namespace Database {
	public partial class SignalTips {
		const string DBName = "signal_tips";
		#region members
		private int m_id = 0;
		private string m_dec = String.Empty;
		private int m_map = 0;
		private int m_signal_tips_cd = 0;
		private int m_signal_tips_show = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, SignalTips> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, SignalTips>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string dec { get { return m_dec; } }
		public int map { get { return m_map; } }
		public int signal_tips_cd { get { return m_signal_tips_cd; } }
		public int signal_tips_show { get { return m_signal_tips_show; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static SignalTips __default = null;
		static int __hash = 0;
		...
		static SignalTips() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( SignalTips ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, SignalTips> idCacheData {
		...
		static SignalTips ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new SignalTips();
				...
				temp.m_map = __mask[ 1 ] ? q.GetInt( DBCache.FID_map, 3 ) : __default.m_map;
				temp.m_signal_tips_cd = __mask[ 2 ] ? q.GetInt( DBCache.FID_signal_tips_cd, 14 ) : __default.m_signal_tips_cd;
				temp.m_signal_tips_show = __mask[ 3 ] ? q.GetInt( DBCache.FID_signal_tips_show, 16 ) : __default.m_signal_tips_show;
 		...
 		public static SignalTips Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			SignalTips ret = null;
		...
		const int VersionHash = 0x723e2172;
		#endregion
	}
}
//EOF
