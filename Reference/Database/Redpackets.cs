...
namespace Database {
	public partial class Redpackets {
		const string DBName = "redpackets";
		#region members
		private int m_id = 0;
		private int m_getMoney = 0;
		private int m_hide = 0;
		private int m_iconExistTime = 0;
		private int m_redGold = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Redpackets> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Redpackets>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int getMoney { get { return m_getMoney; } }
		public int hide { get { return m_hide; } }
		public int iconExistTime { get { return m_iconExistTime; } }
		public int redGold { get { return m_redGold; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Redpackets __default = null;
		static int __hash = 0;
		...
		static Redpackets() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Redpackets ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Redpackets> idCacheData {
		...
		static Redpackets ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Redpackets();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_getMoney = __mask[ 0 ] ? q.GetInt( DBCache.FID_getMoney, 8 ) : __default.m_getMoney;
				temp.m_hide = __mask[ 1 ] ? q.GetInt( DBCache.FID_hide, 4 ) : __default.m_hide;
				temp.m_iconExistTime = __mask[ 2 ] ? q.GetInt( DBCache.FID_iconExistTime, 13 ) : __default.m_iconExistTime;
				temp.m_redGold = __mask[ 4 ] ? q.GetInt( DBCache.FID_redGold, 7 ) : __default.m_redGold;
				temp.m_type = __mask[ 5 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				RedpacketsEx.IsValid_num = __mask[ 3 ];
				if ( RedpacketsEx.onLoadComplexField_num != null ) {
					RedpacketsEx.onLoadComplexField_num( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Redpackets Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Redpackets ret = null;
		...
		const int VersionHash = 0x0321b984;
		#endregion
	}

	public partial class RedpacketsEx {
		public delegate void LoadComplexField( Redpackets data, LuaDatabase.Query q );
		internal static bool IsValid_num = true;
		static LoadComplexField OnLoadComplexField_num = null;
		public static LoadComplexField onLoadComplexField_num {
			get {
				return OnLoadComplexField_num;
			}
		}
	}
}
