...
namespace Database {
	public partial class MonthCardProject {
		const string DBName = "month_card_project";
		#region members
		private int m_id = 0;
		private string m_dec = String.Empty;
		private int m_level1 = 0;
		private int m_level2 = 0;
		private int m_level3 = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, MonthCardProject> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, MonthCardProject>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string dec { get { return m_dec; } }
		public int level1 { get { return m_level1; } }
		public int level2 { get { return m_level2; } }
		public int level3 { get { return m_level3; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static MonthCardProject __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static MonthCardProject() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( MonthCardProject ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, MonthCardProject> idCacheData {
		...
		static MonthCardProject ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new MonthCardProject();
				...
				temp.m_level1 = __mask[ 1 ] ? q.GetInt( DBCache.FID_level1, 6 ) : __default.m_level1;
				temp.m_level2 = __mask[ 2 ] ? q.GetInt( DBCache.FID_level2, 6 ) : __default.m_level2;
				temp.m_level3 = __mask[ 3 ] ? q.GetInt( DBCache.FID_level3, 6 ) : __default.m_level3;
 		...
 		public static MonthCardProject Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			MonthCardProject ret = null;
		...
		const int VersionHash = 0x04318075;
		#endregion
	}
}
//EOF
