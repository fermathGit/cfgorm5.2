...
namespace Database {
	public partial class GirlBless {
		const string DBName = "girlBless";
		#region members
		private int m_id = 0;
		private int m_addExpPer = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, GirlBless> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GirlBless>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int addExpPer { get { return m_addExpPer; } }
		...
		static GirlBless __default = null;
		static int __hash = 0;
		...
		static GirlBless() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GirlBless ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GirlBless> idCacheData {
		...
		static GirlBless ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GirlBless();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_addExpPer = __mask[ 0 ] ? q.GetInt( DBCache.FID_addExpPer, 9 ) : __default.m_addExpPer;
				temp.m_des = __mask[ 2 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_des, 3 ) : __default.m_des;
				...
				GirlBlessEx.IsValid_att = __mask[ 1 ];
				if ( GirlBlessEx.onLoadComplexField_att != null ) {
					GirlBlessEx.onLoadComplexField_att( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static GirlBless Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GirlBless ret = null;
		...
		const int VersionHash = 0x5a42f5c2;
		#endregion
	}

	public partial class GirlBlessEx {
		public delegate void LoadComplexField( GirlBless data, LuaDatabase.Query q );
		internal static bool IsValid_att = true;
		static LoadComplexField OnLoadComplexField_att = null;
		public static LoadComplexField onLoadComplexField_att {
			get {
				return OnLoadComplexField_att;
			}
		}
	}
}
