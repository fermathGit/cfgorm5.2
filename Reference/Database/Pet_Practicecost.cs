...
namespace Database {
	public partial class Pet_Practicecost {
		const string DBName = "pet_practicecost";
		#region members
		private int m_id = 0;
		private int m_costItemDataId = 0;
		private int m_costItemNum = 0;
		private int m_costMoneyNum = 0;
		private int m_costMoneyType = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicecost> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicecost>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int costItemDataId { get { return m_costItemDataId; } }
		public int costItemNum { get { return m_costItemNum; } }
		public int costMoneyNum { get { return m_costMoneyNum; } }
		public int costMoneyType { get { return m_costMoneyType; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Pet_Practicecost __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Pet_Practicecost() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Pet_Practicecost ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicecost> idCacheData {
		...
		static Pet_Practicecost ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Pet_Practicecost();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_costItemDataId = __mask[ 0 ] ? q.GetInt( DBCache.FID_costItemDataId, 14 ) : __default.m_costItemDataId;
				temp.m_costItemNum = __mask[ 1 ] ? q.GetInt( DBCache.FID_costItemNum, 11 ) : __default.m_costItemNum;
				temp.m_costMoneyNum = __mask[ 2 ] ? q.GetInt( DBCache.FID_costMoneyNum, 12 ) : __default.m_costMoneyNum;
				temp.m_costMoneyType = __mask[ 3 ] ? q.GetInt( DBCache.FID_costMoneyType, 13 ) : __default.m_costMoneyType;
				return temp;
			}
			return null;
		}

 		public static Pet_Practicecost Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Pet_Practicecost ret = null;
		...
		const int VersionHash = 0x70e98cce;
		#endregion
	}
}
//EOF
