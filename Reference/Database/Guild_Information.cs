...
namespace Database {
	public partial class Guild_Information {
		const string DBName = "guild_information";
		#region members
		private int m_id = 0;
		private int m_Guildinfor_credit = 0;
		private string m_Guildinfor_name = String.Empty;
		private int m_salaryAddPer = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Guild_Information> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Guild_Information>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int Guildinfor_credit { get { return m_Guildinfor_credit; } }
		public string Guildinfor_name { get { return m_Guildinfor_name; } }
		public int salaryAddPer { get { return m_salaryAddPer; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Guild_Information __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Guild_Information() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Guild_Information ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Guild_Information> idCacheData {
		...
		static Guild_Information ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Guild_Information();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_Guildinfor_credit = __mask[ 0 ] ? q.GetInt( DBCache.FID_Guildinfor_credit, 17 ) : __default.m_Guildinfor_credit;
				temp.m_Guildinfor_name = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_Guildinfor_name, 15 ) : __default.m_Guildinfor_name;
				temp.m_salaryAddPer = __mask[ 4 ] ? q.GetInt( DBCache.FID_salaryAddPer, 12 ) : __default.m_salaryAddPer;
				Guild_InformationEx.IsValid_Guildinfor_proper = __mask[ 2 ];
				Guild_InformationEx.IsValid_Guildinfor_wages = __mask[ 3 ];
				if ( Guild_InformationEx.onLoadComplexField_Guildinfor_proper != null ) {
					Guild_InformationEx.onLoadComplexField_Guildinfor_proper( temp, q );
				}
				if ( Guild_InformationEx.onLoadComplexField_Guildinfor_wages != null ) {
					Guild_InformationEx.onLoadComplexField_Guildinfor_wages( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Guild_Information Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Guild_Information ret = null;
		...
		const int VersionHash = 0x602e6990;
		#endregion
	}

	public partial class Guild_InformationEx {
		public delegate void LoadComplexField( Guild_Information data, LuaDatabase.Query q );
		internal static bool IsValid_Guildinfor_proper = true;
		static LoadComplexField OnLoadComplexField_Guildinfor_proper = null;
		public static LoadComplexField onLoadComplexField_Guildinfor_proper {
			get {
				return OnLoadComplexField_Guildinfor_proper;
			}
		}
		internal static bool IsValid_Guildinfor_wages = true;
		static LoadComplexField OnLoadComplexField_Guildinfor_wages = null;
		public static LoadComplexField onLoadComplexField_Guildinfor_wages {
			get {
				return OnLoadComplexField_Guildinfor_wages;
			}
		}
	}
}
