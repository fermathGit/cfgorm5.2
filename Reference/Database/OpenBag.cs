...
namespace Database {
	public partial class OpenBag {
		const string DBName = "openbag";
		#region members
		private int m_id = 0;
		private int m_need_vip = 0;
		private int m_needgold = 0;
		private int m_needgold_type = 0;
		private int m_needlevel = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, OpenBag> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, OpenBag>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int need_vip { get { return m_need_vip; } }
		public int needgold { get { return m_needgold; } }
		public int needgold_type { get { return m_needgold_type; } }
		public int needlevel { get { return m_needlevel; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static OpenBag __default = null;
		static int __hash = 0;
		...
		static OpenBag() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( OpenBag ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, OpenBag> idCacheData {
		...
		static OpenBag ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new OpenBag();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_need_vip = __mask[ 0 ] ? q.GetInt( DBCache.FID_need_vip, 8 ) : __default.m_need_vip;
				temp.m_needgold = __mask[ 1 ] ? q.GetInt( DBCache.FID_needgold, 8 ) : __default.m_needgold;
				temp.m_needgold_type = __mask[ 2 ] ? q.GetInt( DBCache.FID_needgold_type, 13 ) : __default.m_needgold_type;
				temp.m_needlevel = __mask[ 3 ] ? q.GetInt( DBCache.FID_needlevel, 9 ) : __default.m_needlevel;
				return temp;
			}
			return null;
		}

 		public static OpenBag Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			OpenBag ret = null;
		...
		const int VersionHash = 0x51430c91;
		#endregion
	}
}
//EOF
