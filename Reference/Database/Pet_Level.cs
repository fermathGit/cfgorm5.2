...
namespace Database {
	public partial class Pet_Level {
		const string DBName = "pet_level";
		#region members
		private int m_id = 0;
		private int m_exp_count = 0;
		private int m_expneed = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Pet_Level> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Pet_Level>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int exp_count { get { return m_exp_count; } }
		public int expneed { get { return m_expneed; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Pet_Level __default = null;
		static int __hash = 0;
		...
		static Pet_Level() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Pet_Level ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Pet_Level> idCacheData {
		...
		static Pet_Level ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Pet_Level();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_exp_count = __mask[ 0 ] ? q.GetInt( DBCache.FID_exp_count, 9 ) : __default.m_exp_count;
				temp.m_expneed = __mask[ 1 ] ? q.GetInt( DBCache.FID_expneed, 7 ) : __default.m_expneed;
				return temp;
			}
			return null;
		}

 		public static Pet_Level Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Pet_Level ret = null;
		...
		const int VersionHash = 0x083c58eb;
		#endregion
	}
}
//EOF
