...
namespace Database {
	public partial class CampFightTarget {
		const string DBName = "camp_fighttarget";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, CampFightTarget> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, CampFightTarget>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string describe { get { return m_describe; } }
		public string icon { get { return m_icon; } }
		public int numb { get { return m_numb; } }
		public int show { get { return m_show; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static CampFightTarget __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static CampFightTarget() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( CampFightTarget ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, CampFightTarget> idCacheData {
		...
		static CampFightTarget ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new CampFightTarget();
				...
				temp.m_icon = __mask[ 1 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_icon, 4 ) : __default.m_icon;
				temp.m_numb = __mask[ 2 ] ? q.GetInt( DBCache.FID_numb, 4 ) : __default.m_numb;
				temp.m_show = __mask[ 4 ] ? q.GetInt( DBCache.FID_show, 4 ) : __default.m_show;
				temp.m_type = __mask[ 5 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				CampFightTargetEx.IsValid_rewred = __mask[ 3 ];
				if ( CampFightTargetEx.onLoadComplexField_rewred != null ) {
					CampFightTargetEx.onLoadComplexField_rewred( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static CampFightTarget Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			CampFightTarget ret = null;
		...
		const int VersionHash = 0x3a559194;
		#endregion
	}

	public partial class CampFightTargetEx {
		public delegate void LoadComplexField( CampFightTarget data, LuaDatabase.Query q );
		internal static bool IsValid_rewred = true;
		static LoadComplexField OnLoadComplexField_rewred = null;
		public static LoadComplexField onLoadComplexField_rewred {
			get {
				return OnLoadComplexField_rewred;
			}
		}
	}
}
