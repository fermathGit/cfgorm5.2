...
namespace Database {
	public partial class ArenaPoint {
		const string DBName = "arena_point";
		#region members
		private int m_id = 0;
		private int m_arena_point = 0;
		private int m_pos_max = 0;
		private int m_pos_min = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, ArenaPoint> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ArenaPoint>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int arena_point { get { return m_arena_point; } }
		...
		static ArenaPoint __default = null;
		static int __hash = 0;
		...
		static ArenaPoint() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ArenaPoint ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ArenaPoint> idCacheData {
		...
		static ArenaPoint ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ArenaPoint();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_arena_point = __mask[ 0 ] ? q.GetInt( DBCache.FID_arena_point, 11 ) : __default.m_arena_point;
				...
				ArenaPointEx.IsValid_arena_reward = __mask[ 1 ];
				if ( ArenaPointEx.onLoadComplexField_arena_reward != null ) {
					ArenaPointEx.onLoadComplexField_arena_reward( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static ArenaPoint Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ArenaPoint ret = null;
		...
		const int VersionHash = 0x0748f16b;
		#endregion
	}

	public partial class ArenaPointEx {
		public delegate void LoadComplexField( ArenaPoint data, LuaDatabase.Query q );
		internal static bool IsValid_arena_reward = true;
		static LoadComplexField OnLoadComplexField_arena_reward = null;
		public static LoadComplexField onLoadComplexField_arena_reward {
			get {
				return OnLoadComplexField_arena_reward;
			}
		}
	}
}
