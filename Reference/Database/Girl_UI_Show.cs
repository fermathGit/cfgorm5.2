...
namespace Database {
	public partial class Girl_UI_Show {
		const string DBName = "girl_ui_show";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, Girl_UI_Show> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Girl_UI_Show>();
		#endregion
		#region properties
		...
		static Girl_UI_Show __default = null;
		static int __hash = 0;
		...
		static Girl_UI_Show() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Girl_UI_Show ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Girl_UI_Show> idCacheData {
		...
		static Girl_UI_Show ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Girl_UI_Show();
				...
				Girl_UI_ShowEx.IsValid_Ornam = __mask[ 1 ];
				if ( Girl_UI_ShowEx.onLoadComplexField_Ornam != null ) {
					Girl_UI_ShowEx.onLoadComplexField_Ornam( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static Girl_UI_Show Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Girl_UI_Show ret = null;
		...
		const int VersionHash = 0x5b62f8f6;
		#endregion
	}

	public partial class Girl_UI_ShowEx {
		public delegate void LoadComplexField( Girl_UI_Show data, LuaDatabase.Query q );
		internal static bool IsValid_Ornam = true;
		static LoadComplexField OnLoadComplexField_Ornam = null;
		public static LoadComplexField onLoadComplexField_Ornam {
			get {
				return OnLoadComplexField_Ornam;
			}
		}
	}
}
