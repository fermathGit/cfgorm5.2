...
namespace Database {
	public partial class GrowupReward {
		const string DBName = "growupreward";
		#region members
		private int m_id = 0;
		private string m_gdwatch = String.Empty;
		private int m_groupId = 0;
		private int m_maxTop = 0;
		private int m_minTop = 0;
		private string m_showstring = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, GrowupReward> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GrowupReward>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string gdwatch { get { return m_gdwatch; } }
		public int groupId { get { return m_groupId; } }
		public int maxTop { get { return m_maxTop; } }
		public int minTop { get { return m_minTop; } }
		public string showstring { get { return m_showstring; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static GrowupReward __default = null;
		static int __hash = 0;
		...
		static GrowupReward() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GrowupReward ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GrowupReward> idCacheData {
		...
		static GrowupReward ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GrowupReward();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_gdwatch = __mask[ 0 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_gdwatch, 7 ) : __default.m_gdwatch;
				temp.m_groupId = __mask[ 1 ] ? q.GetInt( DBCache.FID_groupId, 7 ) : __default.m_groupId;
				temp.m_maxTop = __mask[ 2 ] ? q.GetInt( DBCache.FID_maxTop, 6 ) : __default.m_maxTop;
				temp.m_minTop = __mask[ 3 ] ? q.GetInt( DBCache.FID_minTop, 6 ) : __default.m_minTop;
				temp.m_showstring = __mask[ 5 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_showstring, 10 ) : __default.m_showstring;
				GrowupRewardEx.IsValid_rewardItem = __mask[ 4 ];
				if ( GrowupRewardEx.onLoadComplexField_rewardItem != null ) {
					GrowupRewardEx.onLoadComplexField_rewardItem( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static GrowupReward Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GrowupReward ret = null;
		...
		const int VersionHash = 0x67bf4cd7;
		#endregion
	}

	public partial class GrowupRewardEx {
		public delegate void LoadComplexField( GrowupReward data, LuaDatabase.Query q );
