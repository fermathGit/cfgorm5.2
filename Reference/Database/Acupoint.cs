...
namespace Database {
	public partial class AcuPoint {
		const string DBName = "acupoint";
		#region members
		private int m_id = 0;
		private int m_allLevel = 0;
		private string m_desc = String.Empty;
		private int m_haveNum = 0;
		private int m_upNeedLevel = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, AcuPoint> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, AcuPoint>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int allLevel { get { return m_allLevel; } }
		public string desc { get { return m_desc; } }
		public int haveNum { get { return m_haveNum; } }
		public int upNeedLevel { get { return m_upNeedLevel; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static AcuPoint __default = null;
		static int __hash = 0;
		...
		static AcuPoint() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( AcuPoint ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, AcuPoint> idCacheData {
		...
		static AcuPoint ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new AcuPoint();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_allLevel = __mask[ 0 ] ? q.GetInt( DBCache.FID_allLevel, 8 ) : __default.m_allLevel;
				temp.m_desc = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_desc, 4 ) : __default.m_desc;
				temp.m_haveNum = __mask[ 2 ] ? q.GetInt( DBCache.FID_haveNum, 7 ) : __default.m_haveNum;
				temp.m_upNeedLevel = __mask[ 3 ] ? q.GetInt( DBCache.FID_upNeedLevel, 11 ) : __default.m_upNeedLevel;
				return temp;
			}
			return null;
		}

 		public static AcuPoint Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			AcuPoint ret = null;
		...
		const int VersionHash = 0x705ee005;
		#endregion
	}
}
//EOF
