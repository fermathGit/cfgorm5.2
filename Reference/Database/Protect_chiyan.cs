...
namespace Database {
	public partial class Protect_chiyan {
		const string DBName = "protect_chiyan";
		#region members
		private int m_id = 0;
		private int m_chall_limit = 0;
		private int m_interval = 0;
		private int m_level = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Protect_chiyan> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Protect_chiyan>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int chall_limit { get { return m_chall_limit; } }
		public int interval { get { return m_interval; } }
		public int level { get { return m_level; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Protect_chiyan __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Protect_chiyan() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Protect_chiyan ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Protect_chiyan> idCacheData {
		...
		static Protect_chiyan ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Protect_chiyan();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_chall_limit = __mask[ 0 ] ? q.GetInt( DBCache.FID_chall_limit, 11 ) : __default.m_chall_limit;
				temp.m_interval = __mask[ 1 ] ? q.GetInt( DBCache.FID_interval, 8 ) : __default.m_interval;
 		...
 		public static Protect_chiyan Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Protect_chiyan ret = null;
		...
		const int VersionHash = 0x335b1711;
		#endregion
	}
}
//EOF
