...
namespace Database {
	public partial class EquipCollect {
		const string DBName = "equip_collect";
		#region members
		private int m_id = 0;
		private int m_collcetId = 0;
		private string m_Name = String.Empty;
		private int m_number = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, EquipCollect> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, EquipCollect>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int collcetId { get { return m_collcetId; } }
		public string Name { get { return m_Name; } }
		public int number { get { return m_number; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static EquipCollect __default = null;
		static int __hash = 0;
		...
		static EquipCollect() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( EquipCollect ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, EquipCollect> idCacheData {
		...
		static EquipCollect ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new EquipCollect();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_collcetId = __mask[ 1 ] ? q.GetInt( DBCache.FID_collcetId, 9 ) : __default.m_collcetId;
				temp.m_Name = __mask[ 2 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_Name, 4 ) : __default.m_Name;
				temp.m_number = __mask[ 3 ] ? q.GetInt( DBCache.FID_number, 6 ) : __default.m_number;
				EquipCollectEx.IsValid_atttype = __mask[ 0 ];
				if ( EquipCollectEx.onLoadComplexField_atttype != null ) {
					EquipCollectEx.onLoadComplexField_atttype( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static EquipCollect Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
		...
		const int VersionHash = 0x1448d965;
		#endregion
	}

	public partial class EquipCollectEx {
		public delegate void LoadComplexField( EquipCollect data, LuaDatabase.Query q );
		internal static bool IsValid_atttype = true;
		static LoadComplexField OnLoadComplexField_atttype = null;
		public static LoadComplexField onLoadComplexField_atttype {
			get {
				return OnLoadComplexField_atttype;
			}
		}
	}
}
