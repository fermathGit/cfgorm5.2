...
namespace Database {
	public partial class Accessresources {
		const string DBName = "Accessresources";
		#region members
		private int m_id = 0;
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, Accessresources> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Accessresources>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int hide { get { return m_hide; } }
		public int Type { get { return m_Type; } }
		public int Type_id { get { return m_Type_id; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Accessresources __default = null;
		static int __hash = 0;
		...
		static Accessresources() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Accessresources ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Accessresources> idCacheData {
		...
		static Accessresources ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Accessresources();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_hide = __mask[ 0 ] ? q.GetInt( DBCache.FID_hide, 4 ) : __default.m_hide;
				temp.m_Type = __mask[ 1 ] ? q.GetInt( DBCache.FID_Type, 4 ) : __default.m_Type;
				temp.m_Type_id = __mask[ 2 ] ? q.GetInt( DBCache.FID_Type_id, 7 ) : __default.m_Type_id;
				return temp;
			}
			return null;
		}

 		public static Accessresources Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Accessresources ret = null;
		...
		const int VersionHash = 0x2de3a3a9;
		#endregion
	}
}
//EOF
