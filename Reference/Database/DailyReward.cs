...
namespace Database {
	public partial class DailyReward {
		...
		private static Common.Collections.Generic.Lit.Dictionary<int, DailyReward> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, DailyReward>();
		#endregion
		#region properties
		...
		static DailyReward __default = null;
		static int __hash = 0;
		...
		static DailyReward() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( DailyReward ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, DailyReward> idCacheData {
		...
		static DailyReward ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new DailyReward();
				...
				DailyRewardEx.IsValid_show_reward = __mask[ 4 ];
				if ( DailyRewardEx.onLoadComplexField_show_reward != null ) {
					DailyRewardEx.onLoadComplexField_show_reward( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static DailyReward Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			DailyReward ret = null;
	...
	public partial class DailyRewardEx {
		public delegate void LoadComplexField( DailyReward data, LuaDatabase.Query q );
