...
namespace Database {
	public partial class WorldLevel {
		const string DBName = "world_lv";
		#region members
		private int m_id = 0;
		private int m_open_time = 0;
		private int m_world_lv = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, WorldLevel> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, WorldLevel>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int open_time { get { return m_open_time; } }
		public int world_lv { get { return m_world_lv; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static WorldLevel __default = null;
		static int __hash = 0;
		...
		static WorldLevel() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( WorldLevel ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, WorldLevel> idCacheData {
		...
		static WorldLevel ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new WorldLevel();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_open_time = __mask[ 0 ] ? q.GetInt( DBCache.FID_open_time, 9 ) : __default.m_open_time;
				temp.m_world_lv = __mask[ 1 ] ? q.GetInt( DBCache.FID_world_lv, 8 ) : __default.m_world_lv;
				return temp;
			}
			return null;
		}

 		public static WorldLevel Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			WorldLevel ret = null;
		...
		const int VersionHash = 0x3052a96b;
		#endregion
	}
}
//EOF
