...
namespace Database {
	public partial class ShopCarry {
		const string DBName = "shop_carry";
		#region members
		private int m_id = 0;
		private int m_isbind = 0;
		private int m_item_number = 0;
		private int m_itemid = 0;
		private int m_money = 0;
		private int m_support_count = 0;
		private int m_support_sale = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, ShopCarry> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ShopCarry>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int isbind { get { return m_isbind; } }
		public int item_number { get { return m_item_number; } }
		public int itemid { get { return m_itemid; } }
		public int money { get { return m_money; } }
		public int support_count { get { return m_support_count; } }
		public int support_sale { get { return m_support_sale; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static ShopCarry __default = null;
		static int __hash = 0;
		...
		static ShopCarry() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ShopCarry ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ShopCarry> idCacheData {
		...
		static ShopCarry ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ShopCarry();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_isbind = __mask[ 0 ] ? q.GetInt( DBCache.FID_isbind, 6 ) : __default.m_isbind;
				temp.m_item_number = __mask[ 1 ] ? q.GetInt( DBCache.FID_item_number, 11 ) : __default.m_item_number;
				temp.m_itemid = __mask[ 2 ] ? q.GetInt( DBCache.FID_itemid, 6 ) : __default.m_itemid;
				temp.m_money = __mask[ 3 ] ? q.GetInt( DBCache.FID_money, 5 ) : __default.m_money;
				temp.m_support_count = __mask[ 4 ] ? q.GetInt( DBCache.FID_support_count, 13 ) : __default.m_support_count;
				temp.m_support_sale = __mask[ 5 ] ? q.GetInt( DBCache.FID_support_sale, 12 ) : __default.m_support_sale;
				return temp;
			}
			return null;
		}

 		public static ShopCarry Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ShopCarry ret = null;
		...
		const int VersionHash = 0x30f969f3;
		#endregion
	}
}
//EOF
