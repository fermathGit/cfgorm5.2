...
namespace Database {
	public partial class GuildBattle {
		const string DBName = "guildBattle";
		#region members
		private int m_id = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, GuildBattle> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, GuildBattle>();
		#endregion
		#region properties
		...
		static GuildBattle __default = null;
		static int __hash = 0;
		...
		static GuildBattle() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( GuildBattle ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, GuildBattle> idCacheData {
		...
		static GuildBattle ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new GuildBattle();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				GuildBattleEx.IsValid_byeItem = __mask[ 0 ];
				GuildBattleEx.IsValid_loseItem = __mask[ 1 ];
				GuildBattleEx.IsValid_showItem = __mask[ 2 ];
				GuildBattleEx.IsValid_winItem = __mask[ 3 ];
				if ( GuildBattleEx.onLoadComplexField_byeItem != null ) {
					GuildBattleEx.onLoadComplexField_byeItem( temp, q );
				}
				if ( GuildBattleEx.onLoadComplexField_loseItem != null ) {
					GuildBattleEx.onLoadComplexField_loseItem( temp, q );
				}
				if ( GuildBattleEx.onLoadComplexField_showItem != null ) {
					GuildBattleEx.onLoadComplexField_showItem( temp, q );
				}
				if ( GuildBattleEx.onLoadComplexField_winItem != null ) {
					GuildBattleEx.onLoadComplexField_winItem( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static GuildBattle Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			GuildBattle ret = null;
		...
		const int VersionHash = 0x47c14793;
		#endregion
	}

	public partial class GuildBattleEx {
		public delegate void LoadComplexField( GuildBattle data, LuaDatabase.Query q );
		internal static bool IsValid_byeItem = true;
		static LoadComplexField OnLoadComplexField_byeItem = null;
		public static LoadComplexField onLoadComplexField_byeItem {
			get {
				return OnLoadComplexField_byeItem;
			}
		}
		internal static bool IsValid_loseItem = true;
		static LoadComplexField OnLoadComplexField_loseItem = null;
		public static LoadComplexField onLoadComplexField_loseItem {
			get {
				return OnLoadComplexField_loseItem;
			}
		}
		...
		internal static bool IsValid_winItem = true;
		static LoadComplexField OnLoadComplexField_winItem = null;
		public static LoadComplexField onLoadComplexField_winItem {
			get {
				return OnLoadComplexField_winItem;
			}
		}
	}
}
