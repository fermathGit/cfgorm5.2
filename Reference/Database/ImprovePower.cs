...
namespace Database {
	public partial class ImprovePower {
		const string DBName = "ImprovePower";
		#region members
		private int m_id = 0;
		...
		private int m_parameterType = 0;
		private int m_Type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, ImprovePower> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, ImprovePower>();
		#endregion
		#region properties
		...
		public int parameterType { get { return m_parameterType; } }
		public int Type { get { return m_Type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static ImprovePower __default = null;
		static int __hash = 0;
		...
		static ImprovePower() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( ImprovePower ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, ImprovePower> idCacheData {
		...
		static ImprovePower ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new ImprovePower();
				...
				temp.m_parameterType = __mask[ 5 ] ? q.GetInt( DBCache.FID_parameterType, 13 ) : __default.m_parameterType;
				temp.m_Type = __mask[ 7 ] ? q.GetInt( DBCache.FID_Type, 4 ) : __default.m_Type;
				ImprovePowerEx.IsValid_allParameter = __mask[ 0 ];
				ImprovePowerEx.IsValid_Relation_UI = __mask[ 6 ];
				if ( ImprovePowerEx.onLoadComplexField_allParameter != null ) {
					ImprovePowerEx.onLoadComplexField_allParameter( temp, q );
				}
				if ( ImprovePowerEx.onLoadComplexField_Relation_UI != null ) {
					ImprovePowerEx.onLoadComplexField_Relation_UI( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static ImprovePower Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			ImprovePower ret = null;
		...
		const int VersionHash = 0x6cffb763;
		#endregion
	}

	public partial class ImprovePowerEx {
		public delegate void LoadComplexField( ImprovePower data, LuaDatabase.Query q );
		internal static bool IsValid_allParameter = true;
		static LoadComplexField OnLoadComplexField_allParameter = null;
		public static LoadComplexField onLoadComplexField_allParameter {
			get {
				return OnLoadComplexField_allParameter;
			}
		}
