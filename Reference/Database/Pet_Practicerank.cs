...
namespace Database {
	public partial class Pet_Practicerank {
		const string DBName = "pet_practicerank";
		#region members
		private int m_id = 0;
		private int m_maxQuilaty = 0;
		private int m_minQuilaty = 0;
		private int m_upNum = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicerank> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicerank>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int maxQuilaty { get { return m_maxQuilaty; } }
		public int minQuilaty { get { return m_minQuilaty; } }
		public int upNum { get { return m_upNum; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Pet_Practicerank __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static Pet_Practicerank() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Pet_Practicerank ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Pet_Practicerank> idCacheData {
		...
		static Pet_Practicerank ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Pet_Practicerank();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_maxQuilaty = __mask[ 0 ] ? q.GetInt( DBCache.FID_maxQuilaty, 10 ) : __default.m_maxQuilaty;
				temp.m_minQuilaty = __mask[ 1 ] ? q.GetInt( DBCache.FID_minQuilaty, 10 ) : __default.m_minQuilaty;
				temp.m_upNum = __mask[ 2 ] ? q.GetInt( DBCache.FID_upNum, 5 ) : __default.m_upNum;
				return temp;
			}
			return null;
		}

 		public static Pet_Practicerank Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Pet_Practicerank ret = null;
		...
		const int VersionHash = 0x30133749;
		#endregion
	}
}
//EOF
