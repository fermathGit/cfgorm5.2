...
namespace Database {
	public partial class Girl_Talk {
		const string DBName = "girl_talk";
		#region members
		private int m_id = 0;
		private string m_anim = String.Empty;
		private string m_talkcontent = String.Empty;
		private string m_talksound = String.Empty;
		private int m_talktype = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Girl_Talk> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Girl_Talk>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string anim { get { return m_anim; } }
		public string talkcontent { get { return m_talkcontent; } }
		public string talksound { get { return m_talksound; } }
		public int talktype { get { return m_talktype; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Girl_Talk __default = null;
		static int __hash = 0;
		...
		static Girl_Talk() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Girl_Talk ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Girl_Talk> idCacheData {
		...
		static Girl_Talk ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Girl_Talk();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_anim = __mask[ 0 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_anim, 4 ) : __default.m_anim;
				temp.m_talkcontent = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_talkcontent, 11 ) : __default.m_talkcontent;
				temp.m_talksound = __mask[ 2 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_talksound, 9 ) : __default.m_talksound;
				temp.m_talktype = __mask[ 3 ] ? q.GetInt( DBCache.FID_talktype, 8 ) : __default.m_talktype;
				return temp;
			}
			return null;
		}

 		public static Girl_Talk Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Girl_Talk ret = null;
		...
		const int VersionHash = 0x712b5693;
		#endregion
	}
}
//EOF
