...
namespace Database {
	public partial class Pet_Fightadd {
		const string DBName = "pet_fightadd";
		#region members
		private int m_id = 0;
		private string m_Dec = String.Empty;
		private string m_fightadd = String.Empty;
		private int m_icon = 0;
		private int m_maxFightPoint = 0;
		private int m_mingFightPoint = 0;
		private string m_name = String.Empty;
		private int m_quality = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Pet_Fightadd> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Pet_Fightadd>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string Dec { get { return m_Dec; } }
		public string fightadd { get { return m_fightadd; } }
		public int icon { get { return m_icon; } }
		public int maxFightPoint { get { return m_maxFightPoint; } }
		public int mingFightPoint { get { return m_mingFightPoint; } }
		public string name { get { return m_name; } }
		public int quality { get { return m_quality; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Pet_Fightadd __default = null;
		static int __hash = 0;
		...
		static Pet_Fightadd() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Pet_Fightadd ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Pet_Fightadd> idCacheData {
		...
		static Pet_Fightadd ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Pet_Fightadd();
				...
				temp.m_fightadd = __mask[ 1 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_fightadd, 8 ) : __default.m_fightadd;
				temp.m_icon = __mask[ 2 ] ? q.GetInt( DBCache.FID_icon, 4 ) : __default.m_icon;
				temp.m_maxFightPoint = __mask[ 3 ] ? q.GetInt( DBCache.FID_maxFightPoint, 13 ) : __default.m_maxFightPoint;
				temp.m_mingFightPoint = __mask[ 4 ] ? q.GetInt( DBCache.FID_mingFightPoint, 14 ) : __default.m_mingFightPoint;
				temp.m_name = __mask[ 5 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_name, 4 ) : __default.m_name;
				temp.m_quality = __mask[ 6 ] ? q.GetInt( DBCache.FID_quality, 7 ) : __default.m_quality;
				return temp;
			}
			return null;
		}

 		public static Pet_Fightadd Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Pet_Fightadd ret = null;
		...
		const int VersionHash = 0x10243338;
		#endregion
	}
}
//EOF
