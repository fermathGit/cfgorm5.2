...
namespace Database {
	public partial class Subtitle {
		const string DBName = "subtitle";
		#region members
		private int m_id = 0;
		private string m_sound_female = String.Empty;
		private string m_sound_male = String.Empty;
		private string m_sub = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, Subtitle> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, Subtitle>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string sound_female { get { return m_sound_female; } }
		public string sound_male { get { return m_sound_male; } }
		public string sub { get { return m_sub; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static Subtitle __default = null;
		static int __hash = 0;
		...
		static Subtitle() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( Subtitle ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, Subtitle> idCacheData {
		...
		static Subtitle ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new Subtitle();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_sound_female = __mask[ 0 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_sound_female, 12 ) : __default.m_sound_female;
				temp.m_sound_male = __mask[ 1 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_sound_male, 10 ) : __default.m_sound_male;
				temp.m_sub = __mask[ 2 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_sub, 3 ) : __default.m_sub;
				return temp;
			}
			return null;
		}

 		public static Subtitle Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			Subtitle ret = null;
		...
		const int VersionHash = 0x0e27c09c;
		#endregion
	}
}
//EOF
