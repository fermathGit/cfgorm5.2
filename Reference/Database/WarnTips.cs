...
namespace Database {
	public partial class WarnTips {
		const string DBName = "warnTips";
		#region members
		private int m_id = 0;
		private string m_picture = String.Empty;
		private string m_tips1 = String.Empty;
		private string m_tips2 = String.Empty;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, WarnTips> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, WarnTips>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public string picture { get { return m_picture; } }
		public string tips1 { get { return m_tips1; } }
		public string tips2 { get { return m_tips2; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static WarnTips __default = null;
		static int __hash = 0;
		...
		static WarnTips() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( WarnTips ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, WarnTips> idCacheData {
		...
		static WarnTips ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new WarnTips();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_picture = __mask[ 1 ] ? Dataset.DecodeToDatabaseString( q, DBCache.FID_picture, 7 ) : __default.m_picture;
				temp.m_tips1 = __mask[ 2 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_tips1, 5 ) : __default.m_tips1;
				temp.m_tips2 = __mask[ 3 ] ? Dataset.DecodeToLocalizedString( q, DBCache.FID_tips2, 5 ) : __default.m_tips2;
				WarnTipsEx.IsValid_colour = __mask[ 0 ];
				if ( WarnTipsEx.onLoadComplexField_colour != null ) {
					WarnTipsEx.onLoadComplexField_colour( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static WarnTips Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			WarnTips ret = null;
		...
		const int VersionHash = 0x3a09fdd9;
		#endregion
	}

	public partial class WarnTipsEx {
		public delegate void LoadComplexField( WarnTips data, LuaDatabase.Query q );
		internal static bool IsValid_colour = true;
		static LoadComplexField OnLoadComplexField_colour = null;
		public static LoadComplexField onLoadComplexField_colour {
			get {
				return OnLoadComplexField_colour;
			}
		}
	}
}
