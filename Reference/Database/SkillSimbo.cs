...
namespace Database {
	public partial class SkillSimbo {
		const string DBName = "skillsimbo";
		#region members
		private int m_id = 0;
		private int m_auto_rank = 0;
		private int m_maxLevel = 0;
		private int m_simbogroup_active_lv = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, SkillSimbo> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, SkillSimbo>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int auto_rank { get { return m_auto_rank; } }
		public int maxLevel { get { return m_maxLevel; } }
		public int simbogroup_active_lv { get { return m_simbogroup_active_lv; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static SkillSimbo __default = null;
		static int __hash = 0;
		...
		static SkillSimbo() {
			...
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( SkillSimbo ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, SkillSimbo> idCacheData {
		...
		static SkillSimbo ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new SkillSimbo();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_auto_rank = __mask[ 0 ] ? q.GetInt( DBCache.FID_auto_rank, 9 ) : __default.m_auto_rank;
				temp.m_maxLevel = __mask[ 1 ] ? q.GetInt( DBCache.FID_maxLevel, 8 ) : __default.m_maxLevel;
				temp.m_simbogroup_active_lv = __mask[ 4 ] ? q.GetInt( DBCache.FID_simbogroup_active_lv, 20 ) : __default.m_simbogroup_active_lv;
				SkillSimboEx.IsValid_simbo_active_item = __mask[ 2 ];
				SkillSimboEx.IsValid_simbo_active_soul = __mask[ 3 ];
				SkillSimboEx.IsValid_startskill_id = __mask[ 5 ];
				if ( SkillSimboEx.onLoadComplexField_simbo_active_item != null ) {
					SkillSimboEx.onLoadComplexField_simbo_active_item( temp, q );
				}
				if ( SkillSimboEx.onLoadComplexField_simbo_active_soul != null ) {
					SkillSimboEx.onLoadComplexField_simbo_active_soul( temp, q );
				}
				if ( SkillSimboEx.onLoadComplexField_startskill_id != null ) {
					SkillSimboEx.onLoadComplexField_startskill_id( temp, q );
				}
				return temp;
			}
			return null;
 		...
 		public static SkillSimbo Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			SkillSimbo ret = null;
		...
		const int VersionHash = 0x4f45c32c;
		#endregion
	}

	public partial class SkillSimboEx {
		public delegate void LoadComplexField( SkillSimbo data, LuaDatabase.Query q );
		internal static bool IsValid_simbo_active_item = true;
		static LoadComplexField OnLoadComplexField_simbo_active_item = null;
		public static LoadComplexField onLoadComplexField_simbo_active_item {
			get {
				return OnLoadComplexField_simbo_active_item;
			}
		}
		internal static bool IsValid_simbo_active_soul = true;
		static LoadComplexField OnLoadComplexField_simbo_active_soul = null;
		public static LoadComplexField onLoadComplexField_simbo_active_soul {
			get {
				return OnLoadComplexField_simbo_active_soul;
			}
		}
		internal static bool IsValid_startskill_id = true;
		static LoadComplexField OnLoadComplexField_startskill_id = null;
		public static LoadComplexField onLoadComplexField_startskill_id {
			get {
				return OnLoadComplexField_startskill_id;
			}
		}
	}
}
