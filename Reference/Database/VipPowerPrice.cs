...
namespace Database {
	public partial class VipPowerPrice {
		const string DBName = "vip_power_price";
		#region members
		private int m_id = 0;
		private int m_number = 0;
		private int m_price = 0;
		private int m_price_type = 0;
		private int m_type = 0;
		#endregion
		#region caches
		private static IKeys m_ids = null;
		private static Common.Collections.Generic.Lit.Dictionary<int, VipPowerPrice> m_idCache = new Common.Collections.Generic.Lit.Dictionary<int, VipPowerPrice>();
		#endregion
		#region properties
		public int id { get { return m_id; } }
		public int number { get { return m_number; } }
		public int price { get { return m_price; } }
		public int price_type { get { return m_price_type; } }
		public int type { get { return m_type; } }
		#endregion
		#region method
		static LuaTableHandle __this = default( LuaTableHandle );
		static VipPowerPrice __default = null;
		static int __hash = 0;
		static bool __masked = false;

		static VipPowerPrice() {
			LuaDatabase.datasetUnloadEvent += OnUnload;
			if ( Load() ) {
				DBLoadedItems.MarkAutoLoaded( DBName, typeof( VipPowerPrice ) );
			}
		}
		...
		public static Common.Collections.Generic.Lit.Dictionary<int, VipPowerPrice> idCacheData {
		...
		static VipPowerPrice ReadOne( LuaDatabase.Query q, int id ) {
			if ( q.IsTable() ) {
				var temp = new VipPowerPrice();
				var __mask = DBCache.LoadCurrentFieldMask( q, __masked );
				temp.m_id = id;
				temp.m_number = __mask[ 0 ] ? q.GetInt( DBCache.FID_number, 6 ) : __default.m_number;
				temp.m_price = __mask[ 1 ] ? q.GetInt( DBCache.FID_price, 5 ) : __default.m_price;
				temp.m_price_type = __mask[ 2 ] ? q.GetInt( DBCache.FID_price_type, 10 ) : __default.m_price_type;
				temp.m_type = __mask[ 3 ] ? q.GetInt( DBCache.FID_type, 4 ) : __default.m_type;
				return temp;
			}
			return null;
		}

 		public static VipPowerPrice Get( int id ) {
			if ( id == 0 ) {
				return null;
			}
			VipPowerPrice ret = null;
		...
		const int VersionHash = 0x53b4af07;
		#endregion
	}
}
//EOF
